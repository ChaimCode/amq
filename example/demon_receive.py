...
def main():
    ...
    parser.add_option('-p', '--password', dest='password',
                      ...
                      default='guest')
    parser.add_option('-q', '--exchange', dest='exchange',
                      help='message exchange (default: %default)',
                      default='feed')
    parser.add_option('-e', '--queue', dest='queue',
                      help='message queue (default: %default)',
                      default='feed')
    ...
    ch.exchange_declare(options.exchange, 'direct', durable=True, auto_delete=False)
    qname, _, _ = ch.queue_declare(queue=options.queue, durable=True, auto_delete=False)
    ch.queue_bind(qname, options.exchange)
